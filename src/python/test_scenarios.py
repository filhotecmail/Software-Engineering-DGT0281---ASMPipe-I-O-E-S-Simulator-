...
class StudentTestScenarios:
    ...
    def scenario_first_dma_test(self):
        ...
        print(
            f"{Fore.WHITE}Estou no {self.semester} de {self.course} e meio nervoso..."
        )
        print()

        # Simular nervosismo inicial
        print(
            f"{Fore.BLUE}PENSAMENTO: '{self.student_name}: Será que meu código Assembly está certo?'"
        )
        time.sleep(1)
        print(
            f"{Fore.BLUE}PENSAMENTO: 'Vou começar com algo simples... transferir 1KB.'"
        )
        time.sleep(1)
    ...
    def scenario_performance_comparison(self):
        ...
        print(f"{Fore.CYAN}" + "-" * 50)
        print(
            f"{Fore.WHITE}Situação: O professor pediu para comparar DMA com E/S programada."
        )
        ...
        # Preparação do teste
        print(
            f"{Fore.BLUE}PENSAMENTO: 'Vou testar com diferentes tamanhos de dados...'"
        )
    ...
    def scenario_bus_arbitration_discovery(self):
        ...
        print(f"{Fore.CYAN}" + "-" * 50)
        print(
            f"{Fore.WHITE}Situação: Tentei usar múltiplos canais DMA simultaneamente."
        )
        print()
        ...
        print(
            f"{Fore.YELLOW}ALERTA: Conflito detectado! Múltiplos canais querem o barramento!"
        )
    ...
    def scenario_late_night_coding(self):
        ...
        print(
            f"{Fore.GREEN}SUCESSO: Teste passou! Simulador funcionando perfeitamente!"
        )
    ...
    def scenario_presentation_prep(self):
        ...
        print(
            f"{Fore.BLUE}PENSAMENTO: 'Perfeito! Agora estou confiante para apresentar!'"
        )
        print(
            f"{Fore.BLUE}PENSAMENTO: 'Meu simulador está pronto para impressionar a turma!'"
        )
