...
class DMAGUITester:
    ...
    def show_welcome(self):
        ...
        print(
            f"{Fore.YELLOW}{Style.BRIGHT}    SIMULADOR DMA - SISTEMA DE TESTE PROFISSIONAL"
        )
        print(f"{Fore.CYAN}{Style.BRIGHT}" + "=" * 70)
        print(f"{Fore.GREEN}Sistema de análise e validação de performance DMA.")
        print(
            f"{Fore.GREEN}Interface profissional para testes abrangentes e relatórios detalhados."
        )
        print(f"{Fore.CYAN}{Style.BRIGHT}" + "=" * 70 + "\n")
    ...
    def show_test_results(self, test_type):
        ...
        if test_type == 1:  # Teste Básico
            ...
            print(
                f"{Fore.BLUE}  STATUS: Sistema de prioridades funcionando corretamente"
            )
